...
const PysicalHealthImprovments = () => {
  return (
    <>
      ...
      <Link
        className="Link"
        href="/content/Health-improvmets/Pysical/Diabitieschart"
      >
        Diabities chart
      </Link>

      <h2>
        Create a chart for how many time you Masturbate &amp; Try to reduce it.
      </h2>
      <Link
        className="Link"
        href="/content/Health-improvmets/Pysical/Masturbation"
      >
        Masturbation
      </Link>
    </>
